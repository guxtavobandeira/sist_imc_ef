        ...
        <div class="conteudo">
            ...
            <div class="graph-container">
                ...
                <script type="text/javascript">
                    ...
                    function drawGenderChart() {
                        ...
                        var options = {
                            ...
                            width: "100%", // Define a largura como 100% para torná-lo responsivo
                            height: 460,
                            bar: { groupWidth: "95%" },
                ...
                <body>
                    ...
                    <div class="graph-container">
                        <div id="gender_chart" class="chart" style="display: none;"></div>
                        <div id="gender_course_chart" class="chart" style="display: none;"></div>
                        <div id="course_chart" class="chart" style="display: none;"></div>
                    </div>
