...
<body>
    ...
    <style>
        ...
        * {
        ...
        /* Media query para telas entre 1200px e 769px */
@media screen and (max-width: 1300px) and (min-width: 769px) {
    .main-container {
        padding: 0 40px; /* Adiciona margem de 40px ao contêiner principal */
    }
    form .fields .input-field {
        width: calc(50% - 20px); /* Ajusta a largura dos campos para duas colunas com espaço entre eles */
        margin: 10px; /* Adiciona margem entre os campos */
    }
    .main-container form {
        position: relative;
        margin-top: 16px;
