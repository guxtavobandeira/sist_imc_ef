...
<body>
    <button onclick="showGenderChart()">Média de alturas por gênero</button>
    <button onclick="showCourseChart()">Média de alturas por curso</button>
    <button onclick="showGenderCourseChart()">Média de alturas por gênero e curso</button>
