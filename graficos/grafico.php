        ...
        <div class="card-container">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <a href="grafico_alunosporcurso.php">Ver Gráfico</a>
                </div>
            </div>
            <div class="card">
                <!-- Card 2 -->
                ...
                <div class="card-content">
                    ...
                    <a href="grafico_x_altura.php">Ver Gráfico</a>
                </div>
            </div>
            <div class="card">
                <!-- Card 3 -->
                ...
                <div class="card-content">
                    ...
                    <a href="grafico_x_peso.php">Ver Gráfico</a>
                </div>
            </div>
            <div class="card">
                <!-- Card 4 -->
                ...
                <div class="card-content">
                    ...
                    <a href="grafico_resultado_imc_iac.php">Ver Gráfico</a>
                </div>
            </div>
