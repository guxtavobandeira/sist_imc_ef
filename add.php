...
<body>
    ...
    <style>@import url('https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Red+Hat+Display:wght@300;400;700;900&display=swap');
...
.buttons button a{
    ...
    font-weight: 600;
    font-size: 16px;
    align-items: flex-start; /* Ajuste na posição do conteúdo para não estar centralizado verticalmente */
    left: 20px;
...
.main-container {
    ...
    background-color: white;
     /* Adiciona flexbox para alinhar à direita */
    margin-left: auto;
    height: calc(100vh - 40px); /* Altura ajustada para preencher o espaço disponível na tela */
    border-radius: 40px;
...
.input-field input, .input-field select {
    width: 100%; /* Define a largura para 100% para ambos os tipos de campos */
    padding: 0 15px;
    outline: none;
    font-weight: 400;
    color: var(--dkcinza);
